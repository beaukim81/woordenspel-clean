...
const CLUSTER_OPTIONS: {
...
}[] = [
  {
    ...
    border: "border-b-[5px] border-green-800",
    glow: "0 6px 24px rgba(34,197,94,0.45)",
    cardBg: "bg-green-500/12",
    cardBorder: "border-green-500/35",
    hint: "Spin · Spook · Speelgoed",
  },
  {
    cluster: "bl",
    difficulty: "bl",
    ...
    border: "border-b-[5px] border-sky-800",
    glow: "0 6px 24px rgba(14,165,233,0.45)",
    cardBg: "bg-sky-500/12",
    cardBorder: "border-sky-500/35",
    hint: "Blad · Bloem · Blauw",
  },
  {
    cluster: "br",
    difficulty: "br",
    ...
    border: "border-b-[5px] border-orange-800",
    glow: "0 6px 24px rgba(249,115,22,0.45)",
    cardBg: "bg-orange-500/12",
    cardBorder: "border-orange-500/35",
    hint: "Brood · Brug · Bruin",
  },
  {
    cluster: "st",
    difficulty: "st",
    ...
    border: "border-b-[5px] border-teal-800",
    glow: "0 6px 24px rgba(20,184,166,0.45)",
    cardBg: "bg-teal-500/12",
    cardBorder: "border-teal-500/35",
    hint: "Ster · Stoel · Storm",
  },
  {
    cluster: "dr",
    difficulty: "dr",
    ...
    border: "border-b-[5px] border-amber-800",
    glow: "0 6px 24px rgba(245,158,11,0.45)",
    cardBg: "bg-amber-500/12",
    cardBorder: "border-amber-500/35",
    hint: "Draak · Droom · Druif",
  },
  {
    cluster: "sl",
    difficulty: "sl",
    ...
    border: "border-b-[5px] border-pink-800",
    glow: "0 6px 24px rgba(236,72,153,0.45)",
    cardBg: "bg-pink-500/12",
    cardBorder: "border-pink-500/35",
    hint: "Slang · Sleutel · Slim",
  },
  {
    cluster: "tw",
    difficulty: "tw",
    ...
    border: "border-b-[5px] border-purple-800",
    ...
    <div className="min-h-screen min-h-[100dvh] w-full flex flex-col items-center bg-background px-4 pt-5 pb-6 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <span className="text-xs font-black text-yellow-900 select-none">
              C
            </span>
          </motion.div>
      ...
      >
        <div className="flex items-center justify-between mb-2 flex-wrap gap-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="font-black text-yellow-400 text-sm tracking-wider">
              LEVEL {level}
            </span>
          ...
          <span className="text-white/35 text-xs font-black tabular-nums">
            {xpProgress}/50 XP
          </span>
        </div>
        ...
        <div className="relative h-4 bg-white/[0.08] rounded-full border border-white/8 overflow-hidden">
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(90deg, #7c3aed, #a855f7, #facc15, #f59e0b)",
            }}
            initial={{ width: 0 }}
            animate={{
              width: `${xpPct}%`,
      ...
      >
        ...
        <div
          ...
          style={{
            fontSize:
              "clamp(1.5rem, 8vw, 2.8rem)",
            background:
              "linear-gradient(135deg, #fde68a 0%, #facc15 40%, #f59e0b 70%, #d97706 100%)",
  ...
  <div className="grid grid-cols-3 gap-2">
    {CLUSTER_OPTIONS.slice(6, 9).map(
      ...
      <motion.button
        ...
        style={{
          boxShadow:
            "0 8px 32px rgba(245,158,11,0.4), 0 2px 8px rgba(0,0,0,0.3)",
        }}
      >
        <motion.div
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              "linear-gradient(110deg, rgba(255,255,255,0) 30%, rgba(255,255,255,0.28) 50%, rgba(255,255,255,0) 70%)",
          }}
          animate={{
            x: ["-100%", "220%"],
          }}
